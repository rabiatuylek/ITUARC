...
@torch.no_grad()
def run( weights=ROOT / '/home/cal-display1/Documents/hdd2/Rabia/Yolov5/yolov5/runs/train/small/weights/best.pt', 
        source=ROOT / '/home/cal-display1/Documents/hdd2/Rabia/Yolov5/Test/Drone/drone22.mp4',  #file, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '/home/cal-display1/Documents/hdd2/Rabia/Yolov5/yolov5/runs/train/small/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / '/home/cal-display1/Documents/hdd2/Rabia/Yolov5/Test/Drone/drone22.mp4', help='file/dir/URL/glob, 0 for webcam')
