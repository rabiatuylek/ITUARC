...
@torch.no_grad()
def run( weights=ROOT / '/home/cal-display1/Documents/hdd2/Rabia/Yolov5/Tensor/best.engine', 
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '/home/cal-display1/Documents/hdd2/Rabia/Yolov5/Tensor/best.engine', help='model path(s)')
